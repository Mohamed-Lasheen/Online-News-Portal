...
<report name="1" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="1" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="Rentt" datatype="number" precision="10"
     defaultWidth="0" defaultHeight="0"/>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL PERSON.PERSON_ID, PERSON.FIRST_NAME, 
PERSON.LAST_NAME, AUTHOR.AUTHOR_ID, AUTHOR.PLACE, AUTHOR.RENT
FROM AUTHOR, PERSON
WHERE (AUTHOR.AUTHOR_ID = PERSON.PERSON_ID) 
AND AUTHOR.RENT>:Rentt;]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_AUTHOR_ID">
        <displayInfo x="0.90125" y="1.94995" width="2.19763" height="0.79956"
        />
        <dataItem name="AUTHOR_ID" oracleDatatype="number" columnOrder="15"
         width="22" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Author Id">
          <dataDescriptor expression="AUTHOR.AUTHOR_ID"
           descriptiveExpression="AUTHOR_ID" order="4" oracleDatatype="number"
           width="22" precision="8"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="SumRENTPerAUTHOR_ID" source="RENT" function="sum"
         width="22" precision="10" reset="G_AUTHOR_ID" compute="report"
         defaultWidth="120000" defaultHeight="10000" columnFlags="520"
         defaultLabel="Total:">
      ...
      <group name="G_FIRST_NAME">
        <displayInfo x="0.86462" y="3.49951" width="2.27087" height="1.33936"
        />
        <dataItem name="FIRST_NAME" datatype="vchar2" columnOrder="13"
         ...
         columnFlags="33" defaultLabel="First Name">
          <dataDescriptor expression="PERSON.FIRST_NAME"
           descriptiveExpression="FIRST_NAME" order="2" width="60"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LAST_NAME" datatype="vchar2" columnOrder="14"
         width="60" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Last Name">
          <dataDescriptor expression="PERSON.LAST_NAME"
           descriptiveExpression="LAST_NAME" order="3" width="60"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="RENT" oracleDatatype="number" columnOrder="17"
         width="22" defaultWidth="120000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Rent">
          <dataDescriptor expression="AUTHOR.RENT"
           descriptiveExpression="RENT" order="6" oracleDatatype="number"
           width="22" precision="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PLACE" datatype="vchar2" columnOrder="16" width="60"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Place">
          <dataDescriptor expression="AUTHOR.PLACE"
           descriptiveExpression="PLACE" order="5" width="60"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PERSON_ID" oracleDatatype="number" columnOrder="12"
         width="22" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Person Id">
          <dataDescriptor expression="PERSON.PERSON_ID"
           descriptiveExpression="PERSON_ID" order="1" oracleDatatype="number"
           width="22" precision="8"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="SumRENTPerReport" source="RENT" function="sum" width="22"
  ...
  <section name="main">
    <body>
      <frame name="M_G_AUTHOR_ID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="5.56250" height="0.75000"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"/>
        <repeatingFrame name="R_G_AUTHOR_ID" source="G_AUTHOR_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_AUTHOR_ID" source="AUTHOR_ID" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
            />
            <geometryInfo x="0.62500" y="0.00000" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <frame name="M_G_FIRST_NAME_GRPFR">
            ...
            <repeatingFrame name="R_G_FIRST_NAME" source="G_FIRST_NAME"
             printDirection="down" minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.00000" y="0.37500" width="5.56250"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              <field name="F_FIRST_NAME" source="FIRST_NAME" minWidowLines="1"
               spacing="0" alignment="start">
                ...
                <geometryInfo x="0.00000" y="0.37500" width="1.25000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_LAST_NAME" source="LAST_NAME" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="1.25000" y="0.37500" width="1.25000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_RENT" source="RENT" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="2.50000" y="0.37500" width="1.81250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_PLACE" source="PLACE" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="4.31250" y="0.37500" width="1.25000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_FIRST_NAME_HDR">
              <geometryInfo x="0.00000" y="0.18750" width="5.56250"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="allPage"
               basePrintingOn="enclosingObject"/>
              ...
              <text name="B_LAST_NAME" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="1.25000" y="0.18750" width="1.25000"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_RENT" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="2.50000" y="0.18750" width="1.81250"
                 height="0.18750"/>
              ...
              <text name="B_PLACE" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="4.31250" y="0.18750" width="1.25000"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_AUTHOR_ID" minWidowLines="1">
            <textSettings spacing="0"/>
        ...
        <frame name="M_G_AUTHOR_ID_FTR">
          <geometryInfo x="0.12500" y="0.56250" width="5.43750"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_SumRENTPerReport" source="SumRENTPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.93750" y="0.56250" width="1.81250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_SumRENTPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.12500" y="0.56250" width="0.43750"
             height="0.18750"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"/>
              <string>
    ...
    <margin>
      <image name="B_1_SEC2" templateSection="main">
        <geometryInfo x="0.50000" y="0.25000" width="1.40625" height="0.37500"
        />
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="2.95813" y="0.25000" width="0.58362" height="0.16675"
        />
        <textSegment>
  ...
  <reportPrivate defaultReportType="masterDetail" versionFlags2="0"
   templateName="rwblue" sectionTitle="Authers"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGAUTHORIDGRPFR218">
<rw:foreach id="RGAUTHORID2181" src="G_AUTHOR_ID">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader"> Authers <br>Author Id <rw:field id="F_AUTHOR_ID" src="AUTHOR_ID" breakLevel="RGAUTHORID2181" breakValue="&nbsp;"> F_AUTHOR_ID </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    <td valign="top">
    <table class="OraTable" summary="Authers">
     <!-- Header -->
     <thead>
      <tr>
       <th <rw:id id="HBFIRSTNAME218" asArray="no"/> class="OraColumnHeader"> First Name </th>
       <th <rw:id id="HBLASTNAME218" asArray="no"/> class="OraColumnHeader"> Last Name </th>
       <th <rw:id id="HBRENT218" asArray="no"/> class="OraColumnHeader"> Rent </th>
       <th <rw:id id="HBPLACE218" asArray="no"/> class="OraColumnHeader"> Place </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGFIRSTNAME2181" src="G_FIRST_NAME">
       <tr>
        <td <rw:headers id="HFFIRSTNAME218" src="HBFIRSTNAME218"/> class="OraCellText"><rw:field id="FFIRSTNAME218" src="FIRST_NAME" nullValue="&nbsp;"> F_FIRST_NAME </rw:field></td>
        <td <rw:headers id="HFLASTNAME218" src="HBLASTNAME218"/> class="OraCellText"><rw:field id="FLASTNAME218" src="LAST_NAME" nullValue="&nbsp;"> F_LAST_NAME </rw:field></td>
        <td <rw:headers id="HFRENT218" src="HBRENT218"/> class="OraCellNumber"><rw:field id="FRENT218" src="RENT" nullValue="&nbsp;"> F_RENT </rw:field></td>
        <td <rw:headers id="HFPLACE218" src="HBPLACE218"/> class="OraCellText"><rw:field id="FPLACE218" src="PLACE" nullValue="&nbsp;"> F_PLACE </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
...
<table class="OraTable" summary="Authers">
 <tr>
  <th class="OraTotalNumber"> Total: <rw:field id="F_SumRENTPerReport" src="SumRENTPerReport" nullValue="&nbsp;"> F_SumRENTPerReport </rw:field></th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGAUTHORIDGRPFR218" -->
